...
st.write("What makes a good movie? Someone might say a high budget will make good movies, and others might say good directors will make good movies. But is it true? Let's see how each factor correlated with each other and how each factor correlated to a movie's rating.")
show_correlation = st.checkbox("Explore factor correlations")
if show_correlation:
...
st.write("Some people love action movies, while someone else love romantic movies. It is very difficult to compare between genres. However, can you recall the last time a horror movie nominated for Oscar's best picture? ")
show_genres = st.checkbox("Explore genres")
if show_genres:
...
st.write("No one would like to read the subtitles while watching movies, but if you limit yourself to just English language films, you'll miss out on some of the best work out there. Which you like better? Hollywood or Bollywood?")
show_languages = st.checkbox("Explore languages")
if show_languages:
    imdb_rating = load_movie_imdb()
...
st.write("As the saying goes, 'you get what you pay for.' When the products pay 200 million USD to make Titanic, they got one of the best movies in history. However, we will never forget the film 'SAW,' which only had a 1.2 million USD budget but brings horror to the whole world. So, how much do you have to pay to produce a good movie?")
show_budgets = st.checkbox("Explore budgets")
if show_budgets:
    imdb_rating = load_movie_imdb()
...
st.write("Can you sit in the cinema for 4 hours? Do you believe a movie can tell a good story in only 10 minutes? Let's see how runtime will affect the ratings of movies.")
show_runtime = st.checkbox("Explore movie runtime")
if show_runtime:
    imdb_rating = load_movie_imdb()
...
st.write("director/actor: Famous directors and actors often made famous movies. How important are them in movie industries? Who are the top directors producing high-rating movies?In this section, we will explain all this things to you.")
show_director_actor = st.checkbox("Explore directors and actors")
if show_director_actor:
...
st.write("When comes to keywords of movies, what comes to your mind? What about keywords for good movies and bad movies? What is your impression of keyword 'Shark'? Let's explore more into keywords issues")
show_keywords = st.checkbox("Explore Keywords")
if show_keywords:
...
st.write("So, all in all, what do we get?")
show_conclusion = st.checkbox("See the conclusion!")
if show_conclusion:
...
st.write("Action speaks louder than words! Let's train a machine learning model use the factors we mentioned above, and see how it performs.")
show_ml = st.checkbox("Train your own machine learning model!")
if show_ml:
